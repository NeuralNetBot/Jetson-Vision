...
*/
void VisionPipeline::Process(cv::Mat& source0){
	//Step HSL_Threshold0:
	//input
	cv::Mat hslThresholdInput = source0;
	double hslThresholdHue[] = {37.23021582733813, 57.133105802047794};
	double hslThresholdSaturation[] = {59.62230215827338, 98.34470989761093};
 ...
 */
cv::Mat* VisionPipeline::GetHslThresholdOutput(){
 ...
 */
cv::Mat* VisionPipeline::GetCvErodeOutput(){
 ...
 */
cv::Mat* VisionPipeline::GetCvDilateOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* VisionPipeline::GetFindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* VisionPipeline::GetFilterContoursOutput(){
	 ...
	 */
	void VisionPipeline::cvErode(cv::Mat &src, cv::Mat &kernel, cv::Point &anchor, double iterations, int borderType, cv::Scalar &borderValue, cv::Mat &dst) {
	 ...
	 * @param dst Output Image.
	 */
	void VisionPipeline::cvDilate(cv::Mat &src, cv::Mat &kernel, cv::Point &anchor, double iterations, int borderType, cv::Scalar &borderValue, cv::Mat &dst) {
	 ...
	 */
	void VisionPipeline::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
